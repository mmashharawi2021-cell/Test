window.AppUI = (() => {
  ...
  function skeleton() {
    return `<main class="app-shell"><section class="hero skeleton-card"><div class="sk sk-title"></div><div class="sk sk-line"></div><div class="sk sk-actions"></div></section><section class="stats"><article class="skeleton-card"></article><article class="skeleton-card"></article><article class="skeleton-card"></article><article class="skeleton-card"></article></section><section class="workspace"><aside class="archive skeleton-card"></aside><section class="details skeleton-card"></section></section></main>`;
  }
